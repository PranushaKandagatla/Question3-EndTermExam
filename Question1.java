...
class ECE extends Courses{ //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		String subject1 = "Microprocessor"; //write the specific subjects name here  ikkada em chesthav cheyy     hint mechanical deaptment sudu nik ardam ithadi
...
public class Question1 {
	public static void main(String[] args){
		System.out.println("Departments:");//executed
		System.out.println(" 1) ECE \n 2) Mechanical \n 3) CSE");//executed
		System.out.println("Choose the department:");//executed
		Scanner in = new Scanner(System.in);
		int choice = in.nextInt();//executed
		Question1 mn=new Question1();
		switch(choice) {//etla osthadi adi ekkada undi poi sudu em undi ela undi dani ikkada ela thesthav
		case 1:
		{
			//this case is or ECE
		...
		case 2:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			Mechanical Mechanical = new Mechanical();//y he hell u r prinying object pritn function
